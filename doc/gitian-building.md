...
- [Building PIVX](#building-ensurance)
...
git clone https://github.com/ensurance-crypto/ensurance.git
cd ensurance
...
```bash
    ...
    From https://github.com/ensurance-crypto/ensurance
...
For example:
```bash
URL=https://github.com/crowning-/ensurance.git
...
[ensurance/gitian.sigs](https://github.com/ensurance-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
