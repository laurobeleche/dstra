...
In order to support loading of multiple wallets in ensurance-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ensurance.cpp.
...
Changes to ensurance.cpp
----------------------
ensurance.cpp is the entry point into ensurance-qt, and as such, will require some minor modifications to provide hooks for
